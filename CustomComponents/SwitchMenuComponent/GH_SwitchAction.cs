...
namespace GH_ComponentUIToolkit
{
    public class GH_SwitchAction : GH_UndoAction
    {
        private class GH_SwitcherConnectivity
        {
            ...
            public static GH_SwitcherConnectivity Create(GH_SwitchComponent component)
            {
            ...
            public void Apply(GH_SwitchComponent component, GH_Document document)
            {
                if (noUnit)
                {
        ...
        public GH_SwitchAction(GH_SwitchComponent component, string newUnit)
            : base()
        {
            if (component == null)
            {
        ...
        protected override void Internal_Redo(GH_Document doc)
        {
            ...
            if (val == null || !(val is GH_SwitchComponent))
            {
                throw new GH_UndoException("Switcher component with id[" + oldState.ComponentId + "] not found");
            }
            GH_SwitchComponent gH_SwitcherComponent = (GH_SwitchComponent)val;
            if (newUnit != null)
            {
        ...
        protected override void Internal_Undo(GH_Document doc)
        {
            ...
            GH_SwitchComponent component = (GH_SwitchComponent)val;
