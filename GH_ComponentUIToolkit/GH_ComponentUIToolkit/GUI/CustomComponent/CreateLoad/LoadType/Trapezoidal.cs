...
{
    public class Trapezoidal : SubComponent
    {
        ...
        public override void registerEvaluationUnits(EvaluationUnitManager mngr)
        {
            ...
            evaluationUnit.RegisterInputParam(new Param_Number(), "TA", "tA", "description", GH_ParamAccess.item);

            evaluationUnit.RegisterInputParam(new Param_Number(), "TB", "tB", "description", GH_ParamAccess.item);
            ...
            evaluationUnit.Inputs[2].Parameter.Optional = false;
            evaluationUnit.Inputs[3].Parameter.Optional = false;
        }
