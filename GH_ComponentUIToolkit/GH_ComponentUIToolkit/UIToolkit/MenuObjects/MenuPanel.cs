...
{
    public class MenuPanel : GH_CustomAttribute
    {
        private List<GH_CustomAttribute> _controls;

        public GH_Capsule _menu;

        public GH_CustomAttribute _activeControl;
        ...
        public MenuPanel(int index, string id)
            : base(index, id)
        {
            _controls = new List<GH_CustomAttribute>();
            LeftMargin = 3f;
            RightMargin = 3f;
            TopMargin = 3f;
            BottomMargin = 3f;
        ...
        public void AddControl(GH_CustomAttribute _control)
        {
            _controls.Add(_control);
            _control.ParentAttribute = this;
        }
        ...
        public override void Layout()
        {
            ...
            base.Height = num - y;
            RectangleF rectangleF = GH_CustomAttribute.Shrink(base.CanvasBoundary, LeftMargin, RightMargin, TopMargin, BottomMargin);
