...
{
    public class MenuStaticText : GH_CustomAttribute
	{
		...
		public override SizeF ComputeMinSize()
		{
			...
			Size size = TextRenderer.MeasureText(Text, WidgetServer.Default.TextFont);
		...
		public override void Render(WidgetRenderArgs args)
		{
			...
			if (Text != null)
			{
				...
				graphics.DrawString(_text, WidgetServer.Default.TextFont, brush, point);
			}
		}
