...
{
	public class MenuSlider : GH_CustomAttribute
    {
		...
		{
			float height = Math.Max(TextRenderer.MeasureText("1", WidgetServer.Default.SliderValueTagFont).Height, _handleDiameter);
		...
		public override void Layout()
		{
			...
			{
				_textBounds = new System.Drawing.RectangleF(_handleArea.Right + 3f, base.CanvasPivot.Y, CanvasBoundary.Right - (_handleArea.Right + 3f), base.Height);
			}
			else
			{
		...
		public override void Render(WidgetRenderArgs args)
		{
			...
			graphics.DrawString(s, WidgetServer.Default.SliderValueTagFont, solidBrush2, _textBounds, stringFormat);
		}
		...
		public override GH_CustomAttribute IsTtipPoint(System.Drawing.PointF pt)
		{
			if (new System.Drawing.RectangleF(Transform.X, Transform.Y, base.Width, 10f).Contains(pt))
			{
				return this;
			}
			return null;
