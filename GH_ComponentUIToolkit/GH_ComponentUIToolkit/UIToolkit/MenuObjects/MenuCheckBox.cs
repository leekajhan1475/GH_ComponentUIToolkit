...
{
	public class MenuCheckBox : GH_CustomAttribute
	{
		...
		public MenuCheckBox(int index, string id, string tag)
			: base(index, id)
		{
			_checkSize = WidgetServer.Default.CheckBoxSize;
			_padding = WidgetServer.Default.CheckBoxPadding;
			_active = false;
			Tag = tag;
			RenderTag = true;
		}
		...
		public override void Layout()
		{
			...
			_checkBounds = new Rectangle((int)(base.CanvasPivot.X + base.CanvasBoundary.Width - (float)_checkSize.Width), (int)num, _checkSize.Width, _checkSize.Height);
		}
		...
		public override void Render(WidgetRenderArgs args)
		{
			...
			if (RenderTag && Tag != null)
			{
				...
				graphics.DrawString(Tag, WidgetServer.Default.TextFont, brush2, point);
			}
